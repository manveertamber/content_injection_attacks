...
reranker_files = [
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_minilm-reranker_dl19_minilm-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_monot5-base-reranker_dl19_monot5-base-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_monot5-large-reranker_dl19_monot5-large-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_rankt5-base-reranker_dl19_rankt5-base-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_minilm-reranker_dl20_minilm-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_monot5-base-reranker_dl20_monot5-base-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_monot5-large-reranker_dl20_monot5-large-reranker.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_rankt5-base-reranker_dl20_rankt5-base-reranker.jsonl"
]

retriever_files = [
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_bge-base-retriever_dl19_bge-base-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_bge-large-retriever_dl19_bge-large-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_e5-supervised-retriever_dl19_e5-supervised-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_e5-unsupervised-retriever_dl19_e5-unsupervised-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_snowflake-base-retriever_dl19_snowflake-base-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_bge-base-retriever_dl20_bge-base-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_bge-large-retriever_dl20_bge-large-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_e5-supervised-retriever_dl20_e5-supervised-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_e5-unsupervised-retriever_dl20_e5-unsupervised-retriever.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_snowflake-base-retriever_dl20_snowflake-base-retriever.jsonl"
]

judge_files = [
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_gpt4o_dl19_gpt4o.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_llama_3.1_8b_judge_dl19_llama_3.1_8b_judge.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_gpt4o_dl20_gpt4o.jsonl",
    "../targeted_sentences/targeted_sentence_injection_SEO_passages_llama_3.1_8b_judge_dl20_llama_3.1_8b_judge.jsonl"
]
