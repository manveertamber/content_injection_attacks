...
reranker_files = [
    "../keyword_injection_general_passages_dl19_minilm-reranker.jsonl",
    "../keyword_injection_general_passages_dl19_monot5-base-reranker.jsonl",
    "../keyword_injection_general_passages_dl19_monot5-large-reranker.jsonl",
    "../keyword_injection_general_passages_dl19_rankt5-base-reranker.jsonl",
    "../keyword_injection_general_passages_dl20_minilm-reranker.jsonl",
    "../keyword_injection_general_passages_dl20_monot5-base-reranker.jsonl",
    "../keyword_injection_general_passages_dl20_monot5-large-reranker.jsonl",
    "../keyword_injection_general_passages_dl20_rankt5-base-reranker.jsonl"
]

retriever_files = [
    "../keyword_injection_general_passages_dl19_bge-base-retriever.jsonl",
    "../keyword_injection_general_passages_dl19_bge-large-retriever.jsonl",
    "../keyword_injection_general_passages_dl19_e5-supervised-retriever.jsonl",
    "../keyword_injection_general_passages_dl19_e5-unsupervised-retriever.jsonl",
    "../keyword_injection_general_passages_dl19_snowflake-base-retriever.jsonl",
    "../keyword_injection_general_passages_dl20_bge-base-retriever.jsonl",
    "../keyword_injection_general_passages_dl20_bge-large-retriever.jsonl",
    "../keyword_injection_general_passages_dl20_e5-supervised-retriever.jsonl",
    "../keyword_injection_general_passages_dl20_e5-unsupervised-retriever.jsonl",
    "../keyword_injection_general_passages_dl20_snowflake-base-retriever.jsonl"
]

judge_files = [
    "../keyword_injection_general_passages_dl19_gpt4o.jsonl",
    "../keyword_injection_general_passages_dl19_llama_3.1_8b_judge.jsonl",
    "../keyword_injection_general_passages_dl20_gpt4o.jsonl",
    "../keyword_injection_general_passages_dl20_llama_3.1_8b_judge.jsonl",
]
...
def extract_model_name(fname):
    ...
    name = (
        base_name
        .replace("keyword_injection_general_passages_", "")
        .replace(".jsonl", "")
        .replace("dl19_", "")
        .replace("dl20_", "")
    )
...
def main():
    ...
    # AGGREGATORS
    #
    # We'll track for each aggregator:
    #   aggregator[model][loc][p_type][reps] = {
    #       "total": ...,
    #       "success_rank1": ...,
    #       "success_rank5": ...
    #   }
    #
    # For rerankers / retrievers:
    #   success_rank1 = number of times rank == 1
    #   success_rank5 = number of times rank <= 5
    #
    ...
    for fname in reranker_files:
        ...
        with open(fname, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                num_reps = entry.get('num_keyword_repetitions', None)
